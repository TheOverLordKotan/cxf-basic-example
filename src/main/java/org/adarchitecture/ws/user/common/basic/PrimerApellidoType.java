...
/**
 * <p>Clase Java para PrimerApellidoType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PrimerApellidoType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "PrimerApellidoType", propOrder = {
    "value"
})
public class PrimerApellidoType {
