...
/**
 * <p>Clase Java para SegundoApellidoType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="SegundoApellidoType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "SegundoApellidoType", propOrder = {
    "value"
})
public class SegundoApellidoType {
