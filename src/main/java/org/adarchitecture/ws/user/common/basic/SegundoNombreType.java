...
/**
 * <p>Clase Java para SegundoNombreType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="SegundoNombreType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "SegundoNombreType", propOrder = {
    "value"
})
public class SegundoNombreType {
